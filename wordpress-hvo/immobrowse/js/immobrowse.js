...
immobrowse.districtElements = function (realEstates) {
  ...
  var ortsteil = args.ortsteil;
  if (typeof ortsteil != 'undefined'&& ortsteil == district){
        ...
        immobrowse.dom.preview.DataCol(
          ...
          immobrowse.dom.preview.DataRow(
            [
              ...
              immobrowse.dom.preview.DataFieldCol(
                immobrowse.dom.preview.DataFieldRow(
                  immobrowse.dom.preview.DataFieldCaption('Fl&auml;che ca.')
                ),
                immobrowse.dom.preview.DataFieldRow(
